...
import { selectCamperById, selectError, selectLoading } from '../store/campersSlice';
...
import CamperPageContentSkeleton from '../components/CamperPageContentSkeleton';
...
function CamperPage() {
  ...
  return (
    <div className={classes['camper-page']}>
      {loading && <CamperPageContentSkeleton />}
      {!loading && camper && (
        <>
